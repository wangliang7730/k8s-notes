...
![img](assets/image-20200520102949189.png)
...
![img](assets/image-20200520103942580.png)
...
### 9.3.2 RoleBinding、ClusterRoleBinding
...
### 9.3.3 RoleBinding引用ClusterRole进行授权
...
### 9.3.4 实战：创建一个只能管理dev空间下Pods资源的账号
