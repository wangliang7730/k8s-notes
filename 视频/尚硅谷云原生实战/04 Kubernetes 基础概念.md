...
> 🙋‍♂️ 视频说下面 IP 需要和 --pod-network-cidr 一致
>
> ```text
...
> 🙋‍♂️ 报错：[ERROR FileContent--proc-sys-net-ipv4-ip_forward]: /proc/sys/net/ipv4/ip_forward contents are not set to 1
>
> ```shell
